  ...
  edit: (props) => {
    ...
    return [
        ...
        <PanelBody>
          <PanelRow>
            <SelectControl
              ...
              options={[
                { value: "", label: "Light Gray" },
                { value: "has-header-black", label: "Black" },
              ]}
              onChange={(cardStyle) => {
                props.setAttributes({ cardStyle });
              }}
            />
          </PanelRow>
          <PanelRow>
      ...
      <div className="image-toggle-card-block-editor">
          ...
          <MediaUpload
            ...
            render={({ open }) => {
              return props.attributes.images.length > 0 &&
                props.attributes.images.length < 3 ? (
        ...
        >
          Note: Toggle buttons will only appear when two images are selected.
        </span>
