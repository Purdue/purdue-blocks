  ...
  edit: ( props ) => {
    ...
    return [
      <InspectorControls key="1">
        ...
        <div className={`columns ${numColumns === 2 ? 'editor-profile-gallery--md' : numColumns === 1 ? 'editor-profile-gallery--sm' : ''} is-multiline ${props.attributes.bioEditorOpen ? 'bio-editor-open' : ''}`}>
          {
