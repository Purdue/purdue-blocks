...
registerBlockType("purdue-blocks/proofpoint", {
  ...
  edit: (props) => {
    ...
    const ContentTag = props.attributes.hasLead && props.attributes.lead ? "p" : "h2";
    ...
    return [
      ...
      <div className={`pu-proofpoint pu-proofpoint--editor${props.attributes.color === 'black' ? ' pu-proofpoint__black' : ' pu-proofpoint__white'
  ...
  save: (props) => {
    ...
    const ContentTag = props.attributes.hasLead && props.attributes.lead ? "p" : "h2";
    const returned = (
      <div {...blockProps} className={`pu-proofpoint${props.attributes.color === 'black' ? ' pu-proofpoint__black' : ' pu-proofpoint__white'
        }${props.attributes.border ? ' pu-proofpoint__border' : ''
        }
      ${props.attributes.boxshadow ? '' : ' pu-proofpoint__no-shadow'
        }
