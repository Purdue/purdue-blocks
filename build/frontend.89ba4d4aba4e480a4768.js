...
if (null !== h_carousel) var flkty = new Flickity(h_carousel, {
  wrapAround: !0,
  pageDots: !1,
  autoPlay: !1,
...
if (null !== v_carousel) var flkty = new Flickity(v_carousel, {
  wrapAround: !0,
  pageDots: !0,
  autoPlay: !1,
  pauseAutoPlayOnHover: !0,
...
if (null !== n_carousel) var flkty = new Flickity(n_carousel, {
  wrapAround: !0,
  pageDots: !1,
  autoPlay: !1,
  pauseAutoPlayOnHover: !0,
...
jQuery(".purdue_podcast_episode_player").length > 0 && function () {
  ...
  for (var i = 0; i < e.length; i++) {
    ...
    a.addEventListener("loadedmetadata", function () {
      ...
      console.log(this.querySelector(".podcast-volume"));
  ...
  function r() {
    ...
    for (var l in b) {
      if (e = [], t = b[l], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (o = 0; o < t.options.aliases.length; o++) {
        e.push(t.options.aliases[o].toLowerCase());
      }

      for (a = n(t.fn, "function") ? t.fn() : t.fn, r = 0; r < e.length; r++) {
        i = e[r], s = i.split("."), 1 === s.length ? k[s[0]] = a : (!k[s[0]] || k[s[0]] instanceof Boolean || (k[s[0]] = new Boolean(k[s[0]])), k[s[0]][s[1]] = a), g.push((a ? "" : "no-") + s.join("-"));
      }
    }
  }
  ...
  function s(e, t) {
    if ("object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(e)) for (var o in e) {
      L(e, o) && s(o, e[o]);
    } else {
      e = e.toLowerCase();
      var n = e.split("."),
  ...
  function c(e, o, a, n) {
    ...
    if (parseInt(a, 10)) for (; a--;) {
      l = i("div"), l.id = n ? n[a] : c + (a + 1), p.appendChild(l);
    }
  ...
  function f(e, t, o) {
    ...
    for (var r in e) {
      if (e[r] in t) return !1 === o ? e[r] : (a = t[e[r]], n(a, "function") ? p(a, o || t) : a);
    }
  ...
  function h(e, t, a, r) {
    ...
    for (var c, p, f, _, h, v = ["modernizr", "tspan"]; !H.style;) {
      c = !0, H.modElem = i(v.shift()), H.style = H.modElem.style;
    }

    for (f = e.length, p = 0; f > p; p++) {
      if (_ = e[p], h = H.style[_], d(_, "-") && (_ = l(_)), H.style[_] !== o) {
        if (r || n(a, "undefined")) return s(), "pfx" != t || _;

        try {
          H.style[_] = a;
        } catch (e) {}

        if (H.style[_] != h) return s(), "pfx" != t || _;
      }
    }
  ...
  var g = [],
    ...
    addTest: function addTest(e, t, o) {
      b.push({
        name: e,
        fn: t,
        options: o
  ...
  k.prototype = w, k = new k(), k.addTest("cookies", function () {
    try {
  ...
  }), k.addTest("ie8compat", !e.addEventListener && !!t.documentMode && 7 === t.documentMode), k.addTest("serviceworker", "serviceWorker" in navigator), k.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), k.addTest("websockets", "WebSocket" in e && 2 === e.WebSocket.CLOSING);
  ...
  k.inputtypes = function (e) {
    for (var a, n, r, i = e.length, s = ":)", l = 0; i > l; l++) {
      T.setAttribute("type", a = e[l]), r = "text" !== T.type && "style" in T, r && (T.value = s, T.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(a) && T.style.WebkitAppearance !== o ? (x.appendChild(T), n = t.defaultView, r = n.getComputedStyle && "textfield" !== n.getComputedStyle(T, null).WebkitAppearance && 0 !== T.offsetHeight, x.removeChild(T)) : /^(search|tel)$/.test(a) || (r = /^(url|email|number)$/.test(a) ? T.checkValidity && !1 === T.checkValidity() : T.value != s)), j[e[l]] = !!r;
    }

    return j;
  }(S), k.addTest("userdata", !!i("div").addBehavior), k.addTest("video", function () {
    var e = i("video"),
        t = !1;
  ...
  w._prefixes = q, k.addTest("csscalc", function () {
    ...
    var e = "background-image:",
        ...
        o = e + q.join(t + e).slice(0, -e.length);
  ...
  var R = "Moz O ms Webkit",
      z = w._config.usePrefixes ? R.split(" ") : [];
  w._cssomPrefixes = z;
  ...
  k.addTest("touchevents", function () {
    ...
    var a = t.getElementById("smodernizr"),
        ...
        i = /src/i.test(r) && 0 === r.indexOf(o.split(" ")[0]);
    ...
    k.addTest("nthchild", function () {
      for (var t = e.getElementsByTagName("div"), o = !0, a = 0; 5 > a; a++) {
        o = o && t[a].offsetWidth === a % 2 + 1;
      }
    ...
    function o() {
      ...
      function l(o) {
        try {
          ...
          if (r.innerHTML = s + o + s, t.body.insertBefore(r, d), t.body.insertBefore(n, r), n.setSelectionRange ? (n.focus(), n.setSelectionRange(0, 0)) : n.createTextRange && (a = n.createTextRange(), a.collapse(!0), a.moveEnd("character", 0), a.moveStart("character", 0), a.select()), e.find) l = e.find(s + s);else try {
