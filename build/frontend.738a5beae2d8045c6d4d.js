...
if (anchorLinkBlocks && anchorLinkBlocks.length > 0) {
  anchorLinkBlocks.forEach(function (block) {
    var hasAccordion = block.classList.contains("has-accordion") ? true : false;
    var headers = [];
...
window.addEventListener('scroll', function () {
  if (columnRowLine && columnRowLine.length > 0) {
    columnRowLine.forEach(function (t) {
      var thisTop = t.getBoundingClientRect().top;
      var thisBottom = t.getBoundingClientRect().bottom;
...
/***/ "./src/custom-side-menu/frontend.js":
/*!******************************************!*\
  !*** ./src/custom-side-menu/frontend.js ***!
  \******************************************/
/*! no static exports found */
...
var sideMenu = document.querySelectorAll(".custom-side-menu");
var href = window.location.href;
...
if (sideMenu && sideMenu.length > 0) {
  sideMenu.forEach(function (block) {
    var sideMenuLinks = block.querySelectorAll("a");
...
/* harmony import */ var _accordion_frontend_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./accordion/frontend.js */ "./src/accordion/frontend.js");
/* harmony import */ var _accordion_frontend_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_accordion_frontend_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _anchor_link_navigation_frontend_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./anchor-link-navigation/frontend.js */ "./src/anchor-link-navigation/frontend.js");
/* harmony import */ var _anchor_link_navigation_frontend_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_anchor_link_navigation_frontend_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _image_toggle_card_frontend_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./image-toggle-card/frontend.js */ "./src/image-toggle-card/frontend.js");
/* harmony import */ var _custom_side_menu_frontend_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom-side-menu/frontend.js */ "./src/custom-side-menu/frontend.js");
/* harmony import */ var _custom_side_menu_frontend_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_custom_side_menu_frontend_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _podcast_frontend_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./podcast/frontend.js */ "./src/podcast/frontend.js");
/* harmony import */ var _podcast_frontend_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_podcast_frontend_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _video_embed_frontend_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./video-embed/frontend.js */ "./src/video-embed/frontend.js");
/* harmony import */ var _video_embed_frontend_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_video_embed_frontend_js__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _title_hero_frontend_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./title-hero/frontend.js */ "./src/title-hero/frontend.js");
/* harmony import */ var _title_hero_frontend_js__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_title_hero_frontend_js__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _purdue_quote_frontend_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./purdue-quote/frontend.js */ "./src/purdue-quote/frontend.js");
/* harmony import */ var _profile_gallery_frontend_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./profile-gallery/frontend.js */ "./src/profile-gallery/frontend.js");
/* harmony import */ var _purdue_tabs_frontend_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./purdue-tabs/frontend.js */ "./src/purdue-tabs/frontend.js");
/* harmony import */ var _video_hero_frontend__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./video-hero/frontend */ "./src/video-hero/frontend.js");
/* harmony import */ var _columns_row_frontend__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./columns-row/frontend */ "./src/columns-row/frontend.js");
/* harmony import */ var _story_line_frontend__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./story-line/frontend */ "./src/story-line/frontend.js");
/* harmony import */ var _large_featured_story_frontend__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./large-featured-story/frontend */ "./src/large-featured-story/frontend.js");
/* harmony import */ var _large_text_frontend__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./large-text/frontend */ "./src/large-text/frontend.js");
...
var slide = function slide(itemContainer, items, slides, prev, next, dots, className, number, animate, pause, play) {
  var posX1 = 0,
      posX2 = 0,
      posY1 = 0,
      posY2 = 0,
      ...
      allowShift = true,
      dirDetected = false,
      newSlides = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(items.querySelectorAll(className)),
      isPlaying = false; //feature detection
  ...
  } catch (err) {} // Mouse events


  items.onmousedown = dragStart; // Touch events

  items.addEventListener('touchstart', dragStart, passiveIfSupported); // Click events
    ...
    dots.forEach(function (dot, ind) {
      dot.addEventListener("click", function () {
        dots.forEach(function (d, i) {
          if (_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(d.classList).includes("active") && ind !== i) {
...
var activateToggle = function activateToggle(el) {
  ...
  if (!clickedButton.classList.contains('selected')) {
    ...
    var previousSelected = clickedButton.nextSibling || clickedButton.previousSibling;
    previousSelected.classList.remove('selected');
    clickedButton.classList.add('selected'); // Toggle the images

    var correspondingParent = clickedButton.parentElement.parentElement;
    var imageContainer = correspondingParent.children[1];
    var previousImage = imageContainer.querySelector('.pu-image-toggle__images img.show');
    var newImage = imageContainer.querySelector('.pu-image-toggle__images img:not(.show)');
...
/***/ "./src/large-featured-story/frontend.js":
/*!**********************************************!*\
  !*** ./src/large-featured-story/frontend.js ***!
  \**********************************************/
/*! no exports provided */
...
var largeStory = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll(".pu-large-image"));
...
if (largeStory && largeStory.length > 0) {
  largeStory.forEach(function (t) {
    var button = t.querySelector(".pu-lightbox-button");

    if (button) {
      var lightbox = t.querySelector(".pu-lightbox");
    ...
    var closeButton = t.querySelector('.modal--close-button');
    var video = t.querySelector('video');
    ...
    var youtube = t.querySelector('.pu-lightbox-youtube');
    ...
    if (youtube) {
      ...
      var checkYT = setInterval(function () {
        if (typeof YT !== 'undefined' && YT.loaded) {
          var lightboxPlayer = new YT.Player(youtube.id, {
            events: {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  podcloses.forEach(function (podclose) {
  ...
  for (var i = 0; i < e.length; i++) {
    var o = e[i],
      ...
      var t = parseInt(e, 10),
          ...
          n = t - 3600 * o - 60 * a;
      return o < 10 && (o = "0" + o), a < 10 && (a = "0" + a), n < 10 && (n = "0" + n), o + ":" + a + ":" + n;
    };
...
/***/ "./src/profile-gallery/frontend.js":
/*!*****************************************!*\
  !*** ./src/profile-gallery/frontend.js ***!
  \*****************************************/
/*! no exports provided */
...
var toggleButtons = document.querySelectorAll('.profile-gallery-open');

var openModal = function openModal(e) {
  var modalTarget = e.currentTarget.dataset.toggle;
  var window = document.querySelector('html');
  var modalToOpen = document.querySelector("[data-modal=\"".concat(modalTarget, "\"]"));
  window.classList.add('no-scroll-page');
...
var closeModal = function closeModal(e) {
  var window = document.querySelector('html');
  var modalToClose = document.querySelector('.modal-open');
...
var closeButtons = document.querySelectorAll('.modal--close-button');
var secondaryCloseButtons = document.querySelectorAll('.modal--secondary-close-button');
[].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(closeButtons), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(secondaryCloseButtons)).forEach(function (button) {
  button.addEventListener('click', closeModal, false);
});

/***/ }),

/***/ "./src/purdue-quote/frontend.js":
/*!**************************************!*\
  !*** ./src/purdue-quote/frontend.js ***!
  \**************************************/
/*! no exports provided */
...
var quoteGroups = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll(".purdue-block-quote-group"));

if (quoteGroups && quoteGroups.length > 0) {
  quoteGroups.forEach(function (quoteGroup) {
    var quoteWrapper = quoteGroup.querySelector(".purdue-block-quote-wrapper");

    var quotes = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(quoteGroup.querySelectorAll(".purdue-block-quote"));
    ...
    if (quotes && quotes.length > 1) {
      var left = quoteGroup.querySelector(".purdue-block-quote-group__arrow-left");
      var right = quoteGroup.querySelector(".purdue-block-quote-group__arrow-right");

      var dots = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(quoteGroup.querySelectorAll(".purdue-block-quote-group__dot"));

      quoteWrapper.style.left = -quoteGroup.offsetWidth + "px"; // Clone first and last slide

      var firstSlide = quotes[0];
      var lastSlide = quotes[quotes.length - 1];
      ...
      Object(_global__WEBPACK_IMPORTED_MODULE_1__["slide"])(quoteGroup, quoteWrapper, quotes, left, right, dots, ".purdue-block-quote", null, false, null, null);
...
var tabGroups = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll(".pu-blocks-tabs"));

if (tabGroups && tabGroups.length > 0) {
  tabGroups.forEach(function (tabs) {
    var headers = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(tabs.querySelectorAll(".pu-blocks-tabs__header"));

    var panels = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(tabs.querySelectorAll(".pu-blocks-tabs__panel"));

    headers.forEach(function (header, index) {
      var clHeader = header.cloneNode(true);
    ...
    var newHeaders = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(tabs.querySelectorAll(".pu-blocks-tabs__header-mobile"));
...
var threeHeaderTables = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll(".three-header-table"));

if (threeHeaderTables && threeHeaderTables.length > 0) {
  threeHeaderTables.forEach(function (table) {
    var topHeaders = [];
    table.querySelector("thead") ? topHeaders = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(table.querySelectorAll("thead tr th")) : "";
    var sectionHeaderRows = [];

    if (table.querySelector("tbody")) {
      var rows = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(table.querySelectorAll("tbody tr"));

      var contentRow = [];
      rows.forEach(function (tr, index) {
        if (tr.classList.contains("section-header-row")) {
          sectionHeaderRows.push({
            sectionHeaderRow: tr,
            index: index
          });
      ...
      var initialHeader = sectionHeaderRows[0].sectionHeaderRow.querySelector("th");
      initialHeader.classList.add("is-open");
      initialHeader.setAttribute("aria-expanded", "true");

      for (var i = 1; i < sectionHeaderRows[1].index; i++) {
        rows[i].classList.add("show");
      }

      sectionHeaderRows.forEach(function (row, index) {
        var header = row.sectionHeaderRow.querySelector("th");
        header.addEventListener("click", function () {
          if (header.classList.contains("is-open")) {
            ...
            if (index < sectionHeaderRows.length - 1) {
              for (var _i = row.index + 1; _i < sectionHeaderRows[index + 1].index; _i++) {
                rows[_i].classList.remove("show");
              }
            } else {
              for (var _i2 = row.index + 1; _i2 < rows.length; _i2++) {
                rows[_i2].classList.remove("show");
              }
            }
          } else {
            ...
            if (index < sectionHeaderRows.length - 1) {
              for (var _i3 = row.index + 1; _i3 < sectionHeaderRows[index + 1].index; _i3++) {
                rows[_i3].classList.add("show");
              }
            } else {
              for (var _i4 = row.index + 1; _i4 < rows.length; _i4++) {
                rows[_i4].classList.add("show");
              }
            }
          }
        }); //mobile
        ...
        var newSectionHeader = document.createElement("button");
        ...
        newSectionHeader.setAttribute('aria-controls', "section-".concat(id));
        ...
        newSectioncontent.id = "section-".concat(id);
        newSection.appendChild(newSectioncontent);

        var rowTest = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(contentRow[0].querySelectorAll("td"));

        var _loop = function _loop(_i5) {
          var newt = document.createElement("table");
          newt.classList.add('three-header-table-mobile-table');
          var newh = document.createElement("thead");
          var newht = document.createElement("tr");
          var newhth = document.createElement("th");
          var newb = document.createElement("tbody");
          newhth.setAttribute('colspan', "2");
          newhth.setAttribute('aria-expanded', "false");
          newhth.setAttribute('aria-controls', "body-".concat(id, "-").concat(_i5));
          newhth.id = "header-".concat(id, "-").concat(_i5);
          newhth.innerHTML = topHeaders[_i5].innerHTML;
          newht.appendChild(newhth);
          newh.appendChild(newht);
          newt.appendChild(newh);
          newb.id = "body-".concat(id, "-").concat(_i5);

          if (index < sectionHeaderRows.length - 1) {
            for (var n = row.index + 1; n < sectionHeaderRows[index + 1].index - 1; n++) {
              var newtr = document.createElement("tr");

              if (rows[1].querySelector("th")) {
                var newth = document.createElement("th");
                newth.innerHTML = rows[n].querySelector("th").innerHTML;
                newth.id = "body-".concat(id, "-").concat(_i5, "-").concat(n);
                newtr.appendChild(newth);
              }

              var newtb = document.createElement("td");
              newtb.innerHTML = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(rows[n].querySelectorAll("td"))[_i5].innerHTML;
              newtb.setAttribute('headers', "header-".concat(id, "-").concat(_i5, " body-").concat(id, "-").concat(_i5, "-").concat(n));
              newtr.appendChild(newtb);
              newb.appendChild(newtr);
            }
          } else {
            for (var _n = row.index + 1; _n < rows.length; _n++) {
              var _newtr = document.createElement("tr");

              if (rows[_n].querySelector("th")) {
                var _newth = document.createElement("th");

                _newth.innerHTML = rows[_n].querySelector("th").innerHTML;
                _newth.id = "body-".concat(id, "-").concat(_i5, "-").concat(_n);

                _newtr.appendChild(_newth);
              }

              var _newtb = document.createElement("td");

              if (_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(rows[_n].querySelectorAll("td"))[_i5]) {
                _newtb.innerHTML = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(rows[_n].querySelectorAll("td"))[_i5].innerHTML;

                _newtb.setAttribute('headers', "header-".concat(id, "-").concat(_i5, " body-").concat(id, "-").concat(_i5, "-").concat(_n));
              }

              _newtr.appendChild(_newtb);

              newb.appendChild(_newtr);
            }
          }

          newt.appendChild(newb);
          newSectioncontent.appendChild(newt);
          newhth.addEventListener('click', function () {
        ...
        for (var _i5 = 0; _i5 < rowTest.length; _i5++) {
          _loop(_i5);
        }

        table.parentElement.insertBefore(newSection, table);
        newSectionHeader.addEventListener('click', function () {
...
var titleHeros = document.querySelectorAll('.pu-title-hero');

if (titleHeros && titleHeros.length > 0) {
  titleHeros.forEach(function (titleHero) {
    ...
    var pauseButton = titleHero.querySelector('.video-pause-button');
    var playButton = titleHero.querySelector('.video-play-button');
    var video = titleHero.querySelector('video');
...
function onPlayerReady(e) {
  ...
  jQuery(".purdue_video_controls_black_total").text(o), jQuery(".purdue_video_controls_black_elapsed").text("00:00:00"), jQuery("#play").on("click", function () {
    ...
    var t = jQuery(".purdue_video_controls_black_timeline").offset(),
        o = e.clientX,
        a = Math.round(o - t.left),
        n = Math.round(a * player.getDuration() / jQuery(".purdue_video_controls_black_timeline").width());
...
function selectText(e) {
  if (e = document.getElementById(e), document.body.createTextRange) {
    ...
    var o = window.getSelection(),
        _t = document.createRange();

    _t.selectNodeContents(e), o.removeAllRanges(), o.addRange(_t);
...
var videoHeroes = document.querySelectorAll('.video-hero');

if (videoHeroes && videoHeroes.length > 0) {
  videoHeroes.forEach(function (videoHero) {
    var pauseButton = videoHero.querySelector('.video-hero--pause-button');
    var playButton = videoHero.querySelector('.video-hero--play-button');
...
window.addEventListener('scroll', function () {
  if (videoHeroes && videoHeroes.length > 0) {
    videoHeroes.forEach(function (videoHero) {
      ...
      var thisBottom = videoHero.getBoundingClientRect().bottom;
...
var carouselHeros = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(document.querySelectorAll(".video-hero--carousel"));

if (carouselHeros && carouselHeros.length > 0) {
  carouselHeros.forEach(function (carouselHero) {
    var carouselWrapper = carouselHero.querySelector(".video-hero--carousel__wrapper");

    var images = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(carouselHero.querySelectorAll(".video-hero--carousel__image"));
    ...
    if (images && images.length > 1) {
      var left = carouselHero.querySelector(".video-hero--carousel__arrow-left");
      var right = carouselHero.querySelector(".video-hero--carousel__arrow-right");
      var number = carouselHero.querySelector(".video-hero--carousel__current");
      var pause = carouselHero.querySelector(".video-hero--pause-button");
      var play = carouselHero.querySelector(".video-hero--play-button");
      carouselWrapper.style.left = -carouselHero.offsetWidth + "px"; // Clone first and last slide

      var firstSlide = images[0];
      var lastSlide = images[images.length - 1];
      var cloneFirst = firstSlide.cloneNode(true);
      var cloneLast = lastSlide.cloneNode(true);
      carouselWrapper.appendChild(cloneFirst);
      carouselWrapper.insertBefore(cloneLast, firstSlide);
      var autoplay = true;
      Object(_global__WEBPACK_IMPORTED_MODULE_1__["slide"])(carouselHero, carouselWrapper, images, left, right, null, ".video-hero--carousel__image", number, autoplay, pause, play);
