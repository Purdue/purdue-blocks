...
/* harmony import */ var _page_layout_with_sidebar_block_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./page-layout-with-sidebar/block.js */ "./src/page-layout-with-sidebar/block.js");
/**
 * Gutenberg Blocks
 *
...
/***/ "./src/page-layout-with-sidebar/block.js":
/*!***********************************************!*\
  !*** ./src/page-layout-with-sidebar/block.js ***!
  \***********************************************/
/*! no exports provided */
...
registerBlockType('purdue-blocks/page-layout-with-sidebar', {
  // Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
  title: __('Page Layout With Sidebar'),
  // Block title.
  icon: {
    // Specifying a background color to appear with the icon e.g.: in the inserter.
    background: '#fff',
  ...
  // Block description in side panel
  description: __('A layout pattern with a main content area and a sidebar area.'),
  edit: function edit(props) {
    return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(InspectorControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PanelBody, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PanelRow, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(RadioControl, {
      ...
      className: "columns is-multiline".concat(props.attributes.sidebarLocationDesktop === 'left' ? ' column-desktop-reverse' : '', "\n        ").concat(props.attributes.sidebarLocationMobile === 'above' ? ' column-mobile-reverse' : '')
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
