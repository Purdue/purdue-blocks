...
registerBlockType('purdue-blocks/purdue-rss', {
  ...
  edit: function edit(props) {
    var onSubmitURL = function onSubmitURL(e) {
      ...
      apiFetch({
        ...
        props.setAttributes({
          data: data.querySelectorAll("item")
        });
      });
    };

    console.log(props.attributes.data);
    var list = props.attributes.data && props.attributes.data.length > 0 ? _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(props.attributes.data).map(function (el) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("h2", null, "test");
    }) : "";
    var toolbarControls = [{
      icon: pencil,
    ...
    return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(BlockControls, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(ToolbarGroup, {
    ...
    })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(PanelRow, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(TextareaControl, {
      label: "Image Alt Text",
      value: props.attributes.altText,
      onChange: function onChange(altText) {
        return props.setAttributes({
      ...
      className: "news-feed-editor".concat(props.attributes.cardType === 'small' ? ' cta-card-small' : ' cta-card-large').concat(props.attributes.imgLocation === 'left' ? ' cta-card-left' : ' cta-card-right')
      ...
      isPrimary: true,
      type: "submit"
    }, __('Use URL'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
      className: 'news-feed'
    ...
    }, "test", list), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
  ...
  save: function save(props) {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, list);
  }
});
...
registerBlockType('purdue-blocks/title-nav', {
  ...
  edit: function edit(props) {
    ...
    })), props.attributes.addButton ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PanelBody, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PanelRow, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(TextControl, {
      label: "Button Text",
